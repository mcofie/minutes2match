<template>
  <div class="admin-layout">
    ...
    <aside class="admin-sidebar" :class="{ 'admin-sidebar--open': sidebarOpen }">
      ...
      <nav class="sidebar-nav space-y-6">
        <!-- Main / Core -->
        <div>
          <div class="px-3 mb-2 text-xs font-bold text-stone-500 uppercase tracking-widest pl-3">Main</div>
        ...
        <!-- Engagement & App -->
        <div>
          <div class="px-3 mb-2 text-xs font-bold text-stone-500 uppercase tracking-widest pl-3 mt-4">Growth & Engagement</div>
        ...
        <!-- System & Operations -->
        <div>
          <div class="px-3 mb-2 text-xs font-bold text-stone-500 uppercase tracking-widest pl-3 mt-4">System</div>
          ...
          <NuxtLink to="/admin/deletion-requests" class="sidebar-link" @click="sidebarOpen = false">
            <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M19 7l-.867 12.142A2 2 0 0 1 16.138 21H7.862a2 2 0 0 1-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v3M4 7h16"/>
            </svg>
            <span class="label">Deletion Requests</span>
          </NuxtLink>
